                                    ...
                                    ColumnLayout {
                                        ...
                                        Slider {
                                            ...
                                            background: Rectangle {
                                                ...
                                                // Center-based fill: shows deviation from 0 dB.
                                                // At 0 dB the fill has zero height (no color shown).
                                                // Positive gain → fill grows upward from center.
                                                // Negative gain → fill grows downward from center.
                                                Item {
                                                    property real centerY: parent.height / 2
                                                    property real handleY: eqSlider.visualPosition * parent.height
                                                    width: parent.width
                                                    y: Math.min(handleY, centerY)
